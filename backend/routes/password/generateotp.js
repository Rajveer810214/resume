...
const sendOTP = (email, validate) => {
    ...
    <p>Hello ${frontName}! 👋</p>
    <p>Welcome to the Suvidha Foundation Offer Letter web app! 🎉 Verify your account using the OTP provided below:</p>
    <p><b>🔒 Verification OTP: ${otp} 🔒</b></p>
    <p>Thank you for choosing Suvidha Foundation. Your journey begins now!</p>
    <p>Best regards,</p>
    <p>Suvidha Foundation Team 🏅</p>` :
    `<p>Hello ${frontName}! 👋</p>
    <p>We received a request to reset your password for your Suvidha Foundation account. Use the OTP provided below to proceed with the reset:</p>
    ...
    const resultSubject = validate === "Verification" ? "🏅 Suvidha Foundation: Verify Your Account 🏅" : "🔑 Password Reset: Suvidha Foundation  🔑"
    const mailOptions = {
